  ...
  return <div class='division'>
        <form class="row g-2 form shadow rounded " style={{width:'500px', marginLeft:'450px', marginTop:'20px'}}onSubmit={(event)=>{handleSubmit(event)}}>
            ...
            <div class="">
                ...
                <input type="number" class="form-control" placeholder='Phone Number' onChange={(e)=>{handleData(e)}} value={employeeDetails.designation} name='designation'/>
            ...
            <div class="">
                ...
                <input type="email" class="form-control" placeholder='Email' onChange={(e)=>{handleData(e)}} value={employeeDetails.salary} name='salary'/>
